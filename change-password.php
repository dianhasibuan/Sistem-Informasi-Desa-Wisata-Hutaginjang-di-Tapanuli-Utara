...
?>
	...
	<body>
		...
		<div class="top-header">
			...
			<div class="privacy">
				<div class="container">
					<h3 class="wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">Ubah Password</h3>
					<form name="chngpwd" method="post" onSubmit="return valid();">
						...
						<p style="width: 350px;">
							<b>Password Saat Ini</b> <input type="password" name="password" class="form-control" id="exampleInputPassword1" placeholder="Current Password" required="">
						</p>
