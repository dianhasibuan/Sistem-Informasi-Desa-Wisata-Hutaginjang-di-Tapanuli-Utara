...
if (isset($_POST['submit50'])) {
	...
	if ($query->rowCount() > 0) {
		...
		$error = "Email atau Nomor Telepon Anda tidak valid";
	}
}
?>
<!DOCTYPE HTML>
			...
			<div class="container">
				...
				<form name="chngpwd" method="post" onSubmit="return valid();">
					...
					<p style="width: 350px;">
						...
						<b>Email Anda</b> <input type="email" name="email" class="form-control" id="email" placeholder="Reg Email id" required="">
					</p>

					<p style="width: 350px;">

						<b>Nomor Telepon</b> <input type="text" name="mobile" class="form-control" id="mobile" placeholder="Reg Mobile no" required="">
					</p>
					...
					<p style="width: 350px;">
						<button type="submit" name="submit50" class="btn-primary btn">Ubah</button>
					</p>
				</form>
