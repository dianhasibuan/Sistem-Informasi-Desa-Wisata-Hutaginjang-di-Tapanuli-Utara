			...
			<div class="privacy">
				<div class="container">
					...
					<form name="chngpwd" method="post">
						<?php if ($error) { ?><div class="errorWrap"><strong>GAGAL</strong>:<?php echo htmlentities($error); ?> </div><?php } else if ($msg) { ?><div class="succWrap"><strong>BERHASIL</strong>:<?php echo htmlentities($msg); ?> </div><?php } ?>
						...
						<p style="width: 350px;">
							<button type="submit" name="submit6" class="btn-primary btn">Ubah</button>
						</p>
					</form>
