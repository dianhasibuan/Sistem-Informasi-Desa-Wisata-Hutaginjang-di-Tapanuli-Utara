...
if (isset($_POST['submit2'])) {
	...
	$status = 0;
	$sql = "INSERT INTO tblbooking SET PackageId=:pid, UserId=:userid, FromDate=:fromdate, ToDate=:todate, Comment=:comment, status=:status";
					...
					<form name="book" method="post" enctype="multipart/form-data">
						<div class="selectroom_top">
							...
							<div class="col-md-8 selectroom_right wow fadeInRight animated" data-wow-delay=".5s">
								...
								<div class="grand">
									<p>Grand Total</p>
									<h3><?php echo htmlentities($result->PackagePrice + 2000); ?></h3>
								</div>
							</div>
							<div class="clearfix"></div>
							<h3>Details</h3>
							<p style="padding-top: 1%"><?php echo htmlentities($result->PackageDetails); ?> </p> <br><br><br>
							<div class="clearfix"></div>
							<div class="selectroom_top"> <br> <br>
								<h2>Tambahan</h2>
									...
									<ul>
										...
										<?php if ($_SESSION['login']) { ?>
											<li class="spe" align="center">
												<button type="submit" name="submit2" class="btn-primary btn">Pesan</button>
											</li>
										<?php } else { ?>
											<li class="sigi" align="center" style="margin-top: 1%">
												<a href="#" data-toggle="modal" data-target="#myModal4" class="btn-primary btn">Pesan</a>
											</li>
										<?php } ?>
										<div class="clearfix"></div>
									</ul>
