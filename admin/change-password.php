...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Beranda</a><i class="fa fa-angle-right"></i>Profile <i class="fa fa-angle-right"></i> Ubah Password</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
  ...
  <div class="panel-body">
					<form  name="chngpwd" method="post" class="form-horizontal" onSubmit="return valid();">
						...
						<div class="form-group">
							<label class="col-md-2 control-label">Password Saat Ini</label>
							<div class="col-md-8">
