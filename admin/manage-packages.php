	...
	<body>
		<div class="page-container">
			...
			<div class="left-content">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="index.html">Beranda</a><i class="fa fa-angle-right"></i>Daftar Wisata</li>
				</ol>
										...
										foreach ($results as $result) {				?>
											<tr>
												...
												<td>
													...
													<a href="javascript:;" onclick="hapus('<?php echo htmlentities($result->PackageId); ?>')">
		...
		<script>
			function hapus(id) {
				...
				if (r == true) {
					window.location.href = "hapus-package.php?id=" + id;
				} else {
					return false;
				}
			}
