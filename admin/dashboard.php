...
<!--header end here-->
		<!-- <ol class="breadcrumb">
                <li class="breadcrumb-item">Beranda <i class="fa fa-angle-right"></i></li>
            </ol> -->
<!--four-grids here-->
				...
				<div class="four-grids">
					<div class="col-md-3 four-grid">
						<div class="four-w3ls">
							...
							<div class="four-text">
								<h3>Report Data<br>User</h3>
								<button type="button" class="btn btn-primary" onclick="window.location.href='export.php'" >Download Excel</button>
								<br>
								<button type="button" class="btn btn-primary" onclick="window.location.href='exportpdf.php'" >Download PDF</button>
							</div>
